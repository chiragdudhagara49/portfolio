    ...
    return (
        <div className="bg-white text-black-300 p-5 " >
            ...
            <div className="flex flex-wrap justify-around">
                <div className=" w-96 h-96 bg-gray-400 border border-slate-700 rounded-[10px] p-3 m-3" >
            ...
            <div>
                <div className="flex justify-center text-7xl">Why choose us?</div>

                <div><b>Experience:</b> With years of experience in the industry, we've honed our skills and processes to deliver top-notch results.</div>

                <div><b>Collaborative Approach:</b> We believe in working closely with our clients. Your input is invaluable throughout the development process.</div>

                <div><b>Cutting-Edge Technology:</b> We stay updated with the latest trends and technologies to provide modern, future-proof solutions.</div>

                <div><b>Client Satisfaction:</b> Our success is measured by your satisfaction. We're dedicated to exceeding your expectations. </div>
