function About() {
    return (
        <div className="bg-white text-black-300" >
            <div className="flex justify-center text-7xl font-kanit">About Us</div>
            <div className="flex justify-center text-2xl font-lato">We are the best Web developing company since 2020.</div>
            ...
            <div className="flex flex-row py-32 justify-evenly flex-wrap">
                <div className="text-left pt-24">
                    <div className="text-4xl"><b>TEAM MEMBERS</b></div>
                    <div> Meet Some of Our Creative Members.</div>
                </div>
                <div className="flex flex-row-reverse">
                    <div className=" flex justify-center w-11/12 h-[300px] bg-gray-800  border-2 border-slate-700 p-[10px] m-3 bg-opacity-10 backdrop-blur font-lato" >Chirag Dudhagara <br />Developer</div>
                    <div className="flex justify-center w-11/12 h-[300px] bg-gray-800 border-2 border-slate-700 p-[10px] m-3 bg-opacity-10 backdrop-blur font-lato" >Ayush Sutariya<br />Developer</div>
                </div>
            </div>
            ...
            <div className="bg-slate-100">
                <div className="flex text-4xl p-16 font-dmserifdisplay"><b>What We Do!</b></div>
                <div className="flex flex-wrap justify-around pb-20">
                    <div className=" w-96 h-96 shadow-2xl min-h-fit  border border-slate-700 rounded-[10px] p-3 m-3 hover:bg-blue-500 hover:pt-6 duration-500 bg-opacity-10" >
                        ...
                        <div className="p-5 font-lato">Our expert developers craft tailor-made websites that align perfectly with your brand identity and business goals. We leverage the latest technologies to create responsive, fast-loading, and user-friendly websites that engage visitors across all devices.</div>
                    </div>

                    <div className=" w-96 shadow-2xl h-96 min-h-fit  border border-slate-700 rounded-[10px] p-3 m-3 hover:bg-red-400 hover:pt-6 duration-500 bg-opacity-10" >
                        <div className="flex justify-center m-3">
                        ...
                        <div className="p-5 font-lato">Beyond websites, we create web applications that serve specific functions or streamline business processes. From customer portals to data management tools, we've got you covered.</div>
                    </div>

                    <div className=" w-96 h-96 shadow-2xl min-h-fit border border-slate-700 rounded-[10px] p-3 m-3 hover:bg-amber-300 hover:pt-6 duration-500 bg-opacity-10" >
                        <div className="flex justify-center m-3">
                        ...
                        <div className="p-5 font-lato">Our design team focuses on creating visually appealing interfaces and intuitive user experiences. We aim to make every interaction a delightful journey for your website visitors.</div>
                    </div>
                </div>
            ...
            <div className=" flex flex-row justify-center py-28">
                ...
                <div className="flex text-4xl basis-1/3 pt-24 font-dmserifdisplay "><b>Why choose us?</b></div>
            </div>
        </div>
